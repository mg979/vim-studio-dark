...
" Last Updated: lun 15 giu 2020 23:40:20 CEST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if has('nvim')
      ...
      let g:terminal_color_2 = '#608b4e'
      let g:terminal_color_3 = '#f2c38f'
      let g:terminal_color_4 = '#073655'
      let g:terminal_color_5 = '#9a93e1'
      let g:terminal_color_6 = '#569cd6'
      ...
      let g:terminal_color_12 = '#204366'
    ...
    if get(g:Vsd, 'extra_highlight', 1)
      ...
      hi cBraces guifg=#607b9e guibg=NONE guisp=NONE gui=NONE cterm=NONE
      if get(g:Vsd, 'conservative', 0)
  ...
  if has('nvim')
    ...
    let g:terminal_color_11 = '#f2c38f'
  ...
  hi Cursor guifg=#c0c0c0 guibg=#2222ff guisp=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    if get(g:Vsd, 'extra_highlight', 1)
      ...
      hi cBraces ctermfg=203 ctermbg=NONE cterm=NONE
      if get(g:Vsd, 'conservative', 0)
        hi! link cStorageClass Type
        hi! link cppType Type
        hi! link cppStructure Type
  ...
  hi Cursor ctermfg=7 ctermbg=21 cterm=NONE
...
" Color:	special  	#607b9e		203	DarkBlue
