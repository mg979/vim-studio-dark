...
" Last Updated: sab 27 mar 2021 23:11:38 CET
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#2d2d2d', '#cd5c5c', '#7ab87a', '#dada93', '#008080', '#8787af', 'SkyBlue', '#6b6a61', '#4d4d4d', '#cd5c5c', '#98fb98', '#dada93', 'SkyBlue', '#c9acd2', '#42dcd7', '#e6eef3']
  if has('nvim')
  ...
  hi Normal guifg=#c6c6b9 guibg=#2d2d2d gui=NONE cterm=NONE
  let g:Vsd = get(g:, 'Vsd', {})
  ...
  hi PmenuSel	guifg=#555726 guibg=DarkGrey ctermfg=58 ctermbg=248 cterm=bold
  ...
  hi EndOfBuffer guifg=#4d4d4d guibg=NONE gui=NONE cterm=NONE
  hi Comment guifg=#6b6a61 guibg=NONE gui=italic cterm=italic
  hi Folded guifg=#6b6a61 guibg=#404040 gui=NONE cterm=NONE
  hi FoldColumn guifg=#6b6a61 guibg=#333333 gui=NONE cterm=NONE
  hi LineNr guifg=#4d4d4d guibg=NONE gui=italic cterm=italic
  hi SignColumn guifg=#4d4d4d guibg=#1e1e1e gui=italic cterm=italic
  hi VertSplit guifg=#4d4d4d guibg=#1e1e1e gui=NONE cterm=NONE
  hi MatchParen guifg=#cd5c5c guibg=#1e1e1e gui=bold cterm=bold
  hi PmenuThumb guifg=#999966 guibg=#6b6a61 gui=NONE cterm=NONE
  hi StatusLine guifg=#bdb76b guibg=#262626 gui=NONE cterm=NONE
  hi StatusLineNC guifg=#262626 guibg=#262626 gui=NONE cterm=NONE
  hi Todo guifg=fg guibg=#cd5c5c gui=bold cterm=bold
  hi NonText guifg=#4d4d4d guibg=NONE gui=NONE cterm=NONE
  hi ColorColumn guifg=fg guibg=#1e1e1e gui=NONE cterm=NONE
  hi Cursor guifg=#2d2d2d guibg=#dfaf87 gui=NONE cterm=NONE
  hi CursorLine guifg=NONE guibg=#333333 gui=NONE cterm=NONE
  hi! link CursorColumn CursorLine
  hi Conceal guifg=#4d4d4d guibg=NONE gui=NONE cterm=NONE
  hi Ignore guifg=#4d4d4d guibg=NONE gui=NONE cterm=NONE
  hi! link Delimiter Special
  hi TabLine guifg=#999966 guibg=#333333 gui=NONE cterm=NONE
  hi TabLineFill guifg=#6b6a61 guibg=#333333 gui=NONE cterm=NONE
  hi TabLineSel guifg=#dfaf87 guibg=#1e1e1e gui=NONE cterm=NONE
  hi Identifier guifg=SkyBlue guibg=NONE gui=NONE cterm=NONE
  hi Statement guifg=#7ab87a guibg=NONE gui=NONE cterm=NONE
  hi String guifg=#cc8080 guibg=NONE gui=NONE cterm=NONE
  hi Special guifg=#a9a9a9 guibg=NONE gui=NONE cterm=NONE
  hi Title guifg=#ed8e5e guibg=NONE gui=NONE cterm=NONE
  hi SpellBad guifg=#cd5c5c guibg=NONE gui=undercurl cterm=undercurl
  hi SpellCap guifg=SkyBlue guibg=NONE gui=undercurl cterm=undercurl
  hi SpellLocal guifg=SkyBlue guibg=NONE gui=undercurl cterm=undercurl
  hi SpellRare guifg=#c9acd2 guibg=NONE gui=undercurl cterm=undercurl
  hi CursorLineNr guifg=#dada93 guibg=NONE gui=NONE cterm=NONE
  hi DiffChange guifg=NONE guibg=#4d4d4d gui=NONE cterm=NONE
  hi DiffDelete guifg=#cd5c5c guibg=NONE gui=bold cterm=bold
  hi DiffText guifg=NONE guibg=#730b00 gui=bold cterm=bold
  hi diffAdded guifg=#7ab87a guibg=NONE gui=NONE cterm=NONE
  hi diffChanged guifg=#a9a9a9 guibg=NONE gui=NONE cterm=NONE
  hi diffRemoved guifg=#cd5c5c guibg=NONE gui=NONE cterm=NONE
  hi diffDiffer guifg=#a9a9a9 guibg=NONE gui=bold cterm=bold
  hi diffFile guifg=#cc8080 guibg=NONE gui=bold cterm=bold
  hi diffLine guifg=#999966 guibg=NONE gui=italic cterm=italic
  hi GitGutterAdd guifg=#7ab87a guibg=#1e1e1e gui=NONE cterm=NONE
  hi GitGutterChange guifg=#a9a9a9 guibg=#1e1e1e gui=NONE cterm=NONE
  hi GitGutterChangeDelete guifg=#a9a9a9 guibg=#1e1e1e gui=NONE cterm=NONE
  hi GitGutterDelete guifg=#cd5c5c guibg=#1e1e1e gui=NONE cterm=NONE
  hi SignifySignAdd guifg=#7ab87a guibg=#1e1e1e gui=NONE cterm=NONE
  hi SignifySignChange guifg=#a9a9a9 guibg=#1e1e1e gui=NONE cterm=NONE
  hi SignifySignChangeDelete guifg=#a9a9a9 guibg=#1e1e1e gui=NONE cterm=NONE
  hi SignifySignDelete guifg=#cd5c5c guibg=#1e1e1e gui=NONE cterm=NONE
  if !s:italics
  ...
  if get(g:Vsd, 'extra_highlight', 1)
    ...
    hi pythonBytesEscape guifg=#cd5c5c guibg=NONE gui=NONE cterm=NONE
    hi pythonStrFormat guifg=#cd5c5c guibg=NONE gui=NONE cterm=NONE
    hi pythonStrFormatting guifg=#cd5c5c guibg=NONE gui=NONE cterm=NONE
    hi cSpecial guifg=#cd5c5c guibg=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi StatusLine ctermfg=143 ctermbg=235 cterm=NONE
  ...
  hi CursorLineNr ctermfg=186 ctermbg=NONE cterm=NONE
